...
{
    /*
 * BunkerView_V2 (Bunker sprite tint from HP ratio)
 *
 * PURPOSE:
 * Reads WaveManager_V2 bunker HP ratio each frame (optional) and lerps assigned SpriteRenderer colors between healthy
 * and damaged palettes. Resolves missing references via BunkerRoot name heuristics when fields are empty.
 *
 * ---------------------------------------------------------
 * ❌ MUST NOT
 *
