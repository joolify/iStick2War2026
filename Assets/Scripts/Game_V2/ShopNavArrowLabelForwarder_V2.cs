...
{
    /*
     * Forwards canvas label clicks (txt_shop_previous / txt_shop_next) to ShopNavArrowUiButton_V2
     * when the TMP sits on top of or under the world-space TextBTN hit target.
     */
