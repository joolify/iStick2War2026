...
{
    /*
 * BombProjectile_V2 (Arcing bomb projectile + explosion)
 *
 * PURPOSE:
 * Physics-driven bomb drop: inherits horizontal velocity, applies gravity, arms after a short delay, then on
 * trigger impact applies radial damage to bunker/hero via WaveManager_V2 paths and spawns optional explosion VFX.
 *
 * ---------------------------------------------------------
 * ❌ MUST NOT
 *
 * - Own bomber pass cadence (BombPlaneController_V2 / Bombplane_V2 schedule drops).
